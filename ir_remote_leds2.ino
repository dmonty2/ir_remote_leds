 ...
 * Update: Feb 20, 2018 - Update support for newer FastLED and IRLremote libraries.
 * Update: Mar 7, 2018 - Add support for MySensors mesh network. Various small updates.
 * Update: Mar 15, 2018 - Set shutdown timer to include relay.  Fix bug in animated power off from domoticz.
 * 
...
#define WIPE 11
#define AUTOM 12
#define OFFING 13   // track turning off animation
